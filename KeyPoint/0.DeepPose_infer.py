...
from dataLoader.WFLW import get_WFLW_dataloaders, draw_keypoints  # 加载WFLW数据集
...
def main(args):
    ...
    net.load_state_dict(torch.load(weights_path, map_location="cpu")["model"])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='./checkpoints/DeepPose/Best_DeepPose_epoch_30.pth', type=str, help='path to the model')
