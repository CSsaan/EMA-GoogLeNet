...
from ImageClassification.model import VGG # 加载模型
...
def main(args):
    ...
    net = VGG(in_channels=3, num_classes=5).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='./checkpoints/VGG/Best_VGG_epoch_32.pth', type=str, help='path to the model')
