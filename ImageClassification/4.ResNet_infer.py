...
def main(args):
    ...
    net = ResNet(in_channels=3, num_classes=5).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='./checkpoints/ResNet/Best_ResNet_epoch_29.pth', type=str, help='path to the model')
