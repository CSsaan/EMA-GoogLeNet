...
def main(args):
    ...
    net = efficientnet_b0(num_classes=5).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='./checkpoints/EfficientNet/Best_EfficientNet_epoch_30.pth', type=str, help='path to the model')
