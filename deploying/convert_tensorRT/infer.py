...
if __name__ == '__main__':
    model_path = "Best_LeNet_epoch_2.trt"
    tensor1 = np.random.rand(1, 1, 224, 224).astype(np.float32)
    # 初始化
    ...
    # 推理
    session((tensor1, ))
    print(session.outputs_info)
    print(session.outputs_info[0].shape)
    print(session.outputs_info[0].name)
